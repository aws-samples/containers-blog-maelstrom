...
<img src="https://img.shields.io/badge/KEDA-2.16.0-blue"/>
<img src="https://img.shields.io/badge/Karpenter-1.8.0-green"/>
<img src="https://img.shields.io/badge/Kubernetes-1.32-purple"/>
</p>
...
If you are experiencing errors while deploying Karpenter, it can be due to Karpenter repository currently supporting limited versions and you may be having an old version in environmentVariables.sh. Please follow steps below:
...
- <span style="color:green;font-weight:700;font-size:20px">Check file createkarpenter.sh under deployment-->karpenter line 80 - 90 and compare with Karpenter getting started helm https://karpenter.sh/</span>
<br>
...
6. In the terminal run below command to test Karpenter status. If you see error first fix it before moving further
```
...
This will delete all the AWS services and workloads created for the solution.
## Configuration
